  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-[10px] bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center  font-medium tracking-tight text-transparent text-4xl sm:text-6xl"
      >
...
export const LampContainer = ({
  ...
  className?: string;
    ...
    const [sizeReducer, setSizeReducer] = useState(1.3)
    if(typeof window !== 'undefined'){
        useEffect(()=>{
            setSizeReducer(window.innerWidth < 640 ? 2 : 1.3)
        },[window.innerWidth])
    }
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[750px] md:min-h-[800px] flex-col items-center justify-center overflow-hidden bg-neutral-950 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-screen flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          initial={{ opacity: 0.5, width: `${15/sizeReducer}rem` }}
          whileInView={{ opacity: 1, width: `${30/sizeReducer}rem` }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
        ...
        <motion.div
          ...
          initial={{ width: `${8/sizeReducer}rem"`}}
          whileInView={{ width: `${16/sizeReducer}rem` }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
        ...
        ></motion.div>
        <motion.div
          initial={{ width: `${15/sizeReducer}rem` }}
          whileInView={{ width: `${30/sizeReducer}rem` }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
